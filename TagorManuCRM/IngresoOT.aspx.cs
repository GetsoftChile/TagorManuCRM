...
namespace TagorManuCRM
{
    public partial class IngresoOT : System.Web.UI.Page
    {
        ...
        void buscarTicketPorIdUsuarioCreacion()
        {
            ...
            DataTable dt = new DataTable();
            dt = dal.getBuscarTicketBuscadorParametros(idUsuarioCreacion, null, null, null,null,null,null, null,null,null,null).Tables[0];
        ...
        protected void btnGrabar_Click(object sender, EventArgs e)
        {
            try
            {
                if (ddlCategoriaServicio.SelectedValue == "0")
                {
                    lblInfo.Text = "La categoria servicio es obligatoria";
                    divAlerta.Visible = true;
                    return;
                }
                ...
                string ticket = dal.setIngresarOT(idTipificacion, idUsuario, idUsuarioAsignado, "1", txtComentario.Text.Trim(),
                    ...
                    txtSolicitadoPor.Text.Trim(), idZona, ddlArea.SelectedValue, txtFechaAgendamiento.Text, idSucursal,ddlCategoriaServicio.SelectedValue);
                //FIN ingreso
