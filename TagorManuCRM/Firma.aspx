<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Firma.aspx.cs" Inherits="TagorManuCRM.Firma" %>
...
<body>
    ...
    <div class="bottomColumn">
        <asp:DataList ID="dlImageList" RepeatColumns="3" runat="server">
            <ItemTemplate>
                <asp:Image ID="imgShow" ImageUrl='<%# Eval("Name","~/UploadedFiles/{0}")%>' Style="width: 200px"
